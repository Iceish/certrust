...
@section('main')
    ...
    <a href="{{ route('dashboard.certificates.create', ['type'=>'0']) }}" class="btn btn--primary" style="align-self: start;">
                ...
                <x-slot:body class="card">
                    ...
                    <div class="card__header">
                        ...
                        <div class="card__actions">
                            <a href="{{ route('dashboard.certificates.show', ['certificate'=>$rootAuthority->id]) }}"><i class="fa-solid fa-magnifying-glass"></i></a>
                        </div>
                    </div>

                    <div class="card__body">
                        <div class="numeric-info"><p>{{ $rootAuthority->countCertificatesByType()['sub_ca'] }}</p><p>Sub-CA</p></div>
                        <div class="numeric-info"><p>{{ $rootAuthority->countCertificatesByType()['cert'] }}</p><p>Certificates</p></div>
                    </div>
